...
(function ($) {
    $.fn.getDateEditorManager = function(){
        return LigerUIManagers[this[0].id + "_DateEditor"];
    };
        ...
        this.each(function () {
            ...
            var g = {
                ...
                setEnabled: function(){
                    ...
                    g.text.removeClass('l-text-disabled');
                    p.disabled = false;
                },
                getValue: function(){
            ...
            if(p.clear){
                g.clearBtn = $('<div class="l-trigger l-trigger-cancel"><div class="l-trigger-icon"></div></div>');
                g.text.append(g.clearBtn);
            }
            ...
            *************/
            ...
            //点击清除(小叉)的事件
            p.clear && g.clearBtn.click(function(){
                g.inputText.val('');
            });
            ...
            LigerUIManagers[this.id + "_DateEditor"] = g;
        });

        if (this.length == 0) return null;
        if (this.length == 1) return LigerUIManagers[this[0].id + "_DateEditor"];
        var managers = [];
        this.each(function() {
            managers.push(LigerUIManagers[this.id + "_DateEditor"]);
        });
