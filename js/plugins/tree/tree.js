        ...
        this.each(function()
        {
            ...
            var po = {
                ...
                getChildNodeClassName: function(data)
                {
                    ...
                    var node = data.showInNavigation;
                    if (node && node == 0 && data.enableStatus == 0) nodeclassname+='-dh';
                    else if (node && node == 0) nodeclassname+='-h';
                    else if (data.enableStatus == 0) nodeclassname+='-d';
            ...
            $(this).width($(this).parent('div').width() - 12);
            $(this).height($(this).parent('div').height() - 15);
            g.tree = $(this);
