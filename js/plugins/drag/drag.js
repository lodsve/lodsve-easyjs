...
//				$('body').css('cursor', opts.cursor);
	...
	$.fn.draggable.defaults = {
        /**
         * A proxy element to be used when dragging, when set to 'clone', a clone element is used as proxy.
         * If a function is specified, it must return a jQuery object.
         *
		...
		edge:0,
        /**
         * Defines the axis which the dragged elements moves on, available value is 'v' or 'h',
         * when set to null will move across 'v' and 'h' direction.
         */
		axis:null,	// v or h
        /**
